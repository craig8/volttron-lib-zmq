# from volttrontesting import MessageBusTestInterface
# from volttron.types import MessageBusInterface, MessageBusParameters
# from volttron.messagebus.zmq import ZmqMessageBus
# import pytest

# class TestZmqIntegration(MessageBusTestInterface):

#     @pytest.fixture(scope="module")
#     def message_bus_instance(self) -> MessageBusInterface:
#         """Retrieve the message bus instance from the concrete implementation
#         """
#         bus = ZmqMessageBus()
#         return bus

#     @pytest.fixture(scope="module")
#     def message_bus_parameters(self) -> MessageBusParameters:
#         """Allows the concrete test to set up the bus parameters.
#         """
